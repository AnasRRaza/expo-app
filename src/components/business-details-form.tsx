...
import { MOCK_BUSINESS, ONBOARDING_TOTAL_STEPS } from '@/constants/onboarding';
...
// The "Is your business listed below?" screen — shared by Path A (business-details)
// and Path B (company-details); only the title/subtitle/step and next route differ.
interface BusinessDetailsFormProps {
  step: number;
  title: string;
  subtitle: string;
  nextRoute: '/vat-declaration' | '/select-plan';
}
